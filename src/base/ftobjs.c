...
#ifdef ANDROID
    __android_log_print(ANDROID_LOG_VERBOSE, "FreeType", "FT_New_Face %s", pathname);
#endif
...
#ifdef ANDROID
       __android_log_print(ANDROID_LOG_WARN, "FreeType", "Missing Module (ft_open_face_internal)");
#endif
